...
class WP_IAB_Main {
	...
	public function on_admin_init() {
		if ( is_network_admin() ) {
			...
			require $this->dir . '/inc/class-wp-iab-schema.php';
			$this->schema = new WP_IAB_Schema();
		}
	}
