/**
 * This ports changes from https://core.trac.wordpress.org/attachment/ticket/39683/39683.diff back into WP 4.7
 */
...
(function (window, undefined) {
    ...
    window.wp = window.wp || {};
    wp.jsTreeApi = wp.jsTreeApi || new WP_API();
    wp.jsTreeApi.versionString = wp.jsTreeApi.versionString || 'wp/v2/';
...
(function (window, undefined) {
    ...
    window.wp = window.wp || {};
    wp.jsTreeApi = wp.jsTreeApi || {};
    wp.jsTreeApi.utils = wp.jsTreeApi.utils || {};
     ...
     * @param {Date} date.
     */
    wp.jsTreeApi.utils.parseISO8601 = function (date) {
     ...
     */
    wp.jsTreeApi.utils.getRootUrl = function () {
     ...
     */
    wp.jsTreeApi.utils.capitalize = function (str) {
     ...
     */
    wp.jsTreeApi.utils.extractRoutePart = function (route, part) {
        var routeParts;

        part = part || 1;

        // Remove versions string from route to avoid returning it.
        route = route.replace(wp.jsTreeApi.versionString, '');
     ...
     */
    wp.jsTreeApi.utils.extractParentName = function (route) {
        var name,
     ...
     *                                to add the args to.
     */
    wp.jsTreeApi.utils.decorateFromRoute = function (routeEndpoints, modelInstance) {
     ...
     */
    wp.jsTreeApi.utils.addMixinsAndHelpers = function (model, modelClassName, loadingObjects) {
        ...
        var hasDate = false,
            ...
            TimeStampedMixin = {
                ...
                getDate: function (field) {
                    ...
                    return new Date(wp.jsTreeApi.utils.parseISO8601(theISODate));
                }
            },
            ...
            buildModelGetter = function (parentModel, modelId, modelName, embedSourcePoint, embedCheckField) {
                ...
                getModel = new wp.jsTreeApi.models[modelName](attributes);
            ...
            buildCollectionGetter = function (parentModel, collectionName, embedSourcePoint, embedIndex) {
                 ...
                 *
                 * @return {Deferred.promise} promise Resolves to a wp.jsTreeApi.collections[ collectionName ]
                 * collection.
                 */
                ...
                getObjects = new wp.jsTreeApi.collections[collectionName](properties, classProperties);
            ...
            TagsMixin = {
                ...
                getTags: function () {
                    var tagIds = this.get('tags'),
                        tags = new wp.jsTreeApi.collections.Tags();
                ...
                setTags: function (tags) {
                    ...
                    if (_.isArray(tags)) {
                        ...
                        // Get all the tags.
                        allTags = new wp.jsTreeApi.collections.Tags();
                        allTags.fetch({
                            data: {per_page: 100},
                            success: function (alltags) {
                                ...
                                _.each(tags, function (tag) {
                                    newTag = new wp.jsTreeApi.models.Tag(alltags.findWhere({slug: tag}));
                                ...
                                tags = new wp.jsTreeApi.collections.Tags(newTags);
            ...
            CategoriesMixin = {
                ...
                getCategories: function () {
                    var categoryIds = this.get('categories'),
                        categories = new wp.jsTreeApi.collections.Categories();
                ...
                setCategories: function (categories) {
                    ...
                    if (_.isArray(categories)) {
                        ...
                        allCategories = new wp.jsTreeApi.collections.Categories();
                        allCategories.fetch({
                            data: {per_page: 100},
                            success: function (allcats) {
                                ...
                                _.each(categories, function (category) {
                                    newCategory = new wp.jsTreeApi.models.Category(allcats.findWhere({slug: category}));
                                ...
                                categories = new wp.jsTreeApi.collections.Categories(newCategories);
...
(function () {
     ...
     */
    wp.jsTreeApi.WPApiBaseModel = Backbone.Model.extend(
     ...
     */
    wp.jsTreeApi.models.Schema = wp.jsTreeApi.WPApiBaseModel.extend(
        /** @lends Schema.prototype  */
        {
            ...
            initialize: function (attributes, options) {
                ...
                wp.jsTreeApi.WPApiBaseModel.prototype.initialize.call(model, attributes, options);
...
(function () {
     ...
     */
    wp.jsTreeApi.WPApiBaseCollection = Backbone.Collection.extend(
...
(function () {
    ...
    Endpoint = Backbone.Model.extend({
        defaults: {
            ...
            versionString: wp.jsTreeApi.versionString,
            schema: null,
            models: {},
            collections: {}
        },
        ...
        initialize: function () {
            ...
            model.schemaModel = new wp.jsTreeApi.models.Schema(null, {
        ...
        constructFromSchema: function () {
            ...
            modelRoutes = [];
            collectionRoutes = [];
            schemaRoot = routeModel.get('apiRoot').replace(wp.jsTreeApi.utils.getRootUrl(), '');
            loadingObjects = {};
            ...
            _.each(modelRoutes, function (modelRoute) {
                ...
                var modelClassName,
                    routeName = wp.jsTreeApi.utils.extractRoutePart(modelRoute.index, 2),
                    parentName = wp.jsTreeApi.utils.extractRoutePart(modelRoute.index, 4),
                    routeEnd = wp.jsTreeApi.utils.extractRoutePart(modelRoute.index, 1);
                ...
                if ('' !== parentName && parentName !== routeName) {
                    modelClassName = wp.jsTreeApi.utils.capitalize(parentName) + wp.jsTreeApi.utils.capitalize(routeName);
                    modelClassName = mapping.models[modelClassName] || modelClassName;
                    loadingObjects.models[modelClassName] = wp.jsTreeApi.WPApiBaseModel.extend({
                    ...
                    modelClassName = wp.jsTreeApi.utils.capitalize(routeName);
                    modelClassName = mapping.models[modelClassName] || modelClassName;
                    loadingObjects.models[modelClassName] = wp.jsTreeApi.WPApiBaseModel.extend({
                ...
                wp.jsTreeApi.utils.decorateFromRoute(modelRoute.route.endpoints, loadingObjects.models[modelClassName]);
            ...
            _.each(collectionRoutes, function (collectionRoute) {
                ...
                var collectionClassName, modelClassName,
                    ...
                    parentName = wp.jsTreeApi.utils.extractRoutePart(collectionRoute.index, 3);

                // If the collection has a parent in its route, add that to its class name.
                if ('' !== parentName && parentName !== routeName) {

                    collectionClassName = wp.jsTreeApi.utils.capitalize(parentName) + wp.jsTreeApi.utils.capitalize(routeName);
                    ...
                    loadingObjects.collections[collectionClassName] = wp.jsTreeApi.WPApiBaseCollection.extend({
                    ...
                    collectionClassName = wp.jsTreeApi.utils.capitalize(routeName);
                    modelClassName = mapping.models[collectionClassName] || collectionClassName;
                    collectionClassName = mapping.collections[collectionClassName] || collectionClassName;
                    loadingObjects.collections[collectionClassName] = wp.jsTreeApi.WPApiBaseCollection.extend({
                ...
                // Add defaults to the new model, pulled form the endpoint.
                wp.jsTreeApi.utils.decorateFromRoute(collectionRoute.route.endpoints, loadingObjects.collections[collectionClassName]);
            });

            // Add mixins and helpers for each of the models.
            _.each(loadingObjects.models, function (model, index) {
                loadingObjects.models[index] = wp.jsTreeApi.utils.addMixinsAndHelpers(model, index, loadingObjects);
            });
    ...
    wp.jsTreeApi.endpoints = new Backbone.Collection();
     ...
     */
    wp.jsTreeApi.init = function (args) {
        ...
        if (!initializedDeferreds[attributes.apiRoot + attributes.versionString]) {
            ...
            endpoint = wp.jsTreeApi.endpoints.findWhere({
            ...
            endpoint.schemaConstructed.done(function (resolvedEndpoint) {
                wp.jsTreeApi.endpoints.add(resolvedEndpoint);

                // Map the default endpoints, extending any already present items (including Schema model).
                wp.jsTreeApi.models = _.extend(wp.jsTreeApi.models, resolvedEndpoint.get('models'));
                wp.jsTreeApi.collections = _.extend(wp.jsTreeApi.collections, resolvedEndpoint.get('collections'));
    ...
    // The wp.jsTreeApi.init function returns a promise that will resolve with the endpoint once it is ready.
    wp.jsTreeApi.loadPromise = wp.jsTreeApi.init();
