...
class tree
{
	...
	public function rn($id, $data) {
		if(!(int)$this->db->get_var('SELECT 1 AS res FROM '.$this->options['structure_table'].' WHERE '.$this->options['structure']['id'].' = '.(int)$id)) {
